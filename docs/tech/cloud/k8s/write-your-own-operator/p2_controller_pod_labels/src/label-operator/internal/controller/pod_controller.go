...
const (
	addPodNameLabelAnnotation = "nvatuan.jp/add-pod-name-label"
	podNameLabel              = "nvatuan.jp/pod-name"
)
...
func (r *PodReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if labelShouldBePresent {
		...
		logger.Info("adding label to Pod")
	} else {
		delete(pod.Labels, podNameLabel)
		logger.Info("removing label from Pod")
	}
